...
const All_Recent_Book = ({bookdata,Addnot,bookAddincart,BNO}) => {
     const i=0;
  ...
  return (
    ...
    <>
     <h1 style={{backgroundColor:"goldenrod",color:"green",fontFamily:"cursive"}}>All Recent Books</h1>
    {bookdata.map((items,i)=>
 
   
(        
        <>
        <div class="card " style={{width:"15rem"}} key={items.id}>
...
export default  All_Recent_Book