...
const All_New_Book = ({bookdata,Addnot,bookAddincart,BNO}) => {
     const i=0;
  ...
  return (
    <>
      <h1 style={{backgroundColor:"goldenrod",color:"green",fontFamily:"cursive"}}>All New Books</h1>

    {bookdata.map((items,i)=>
 
 {

      if(items.cetegory==="newbook")
        {
